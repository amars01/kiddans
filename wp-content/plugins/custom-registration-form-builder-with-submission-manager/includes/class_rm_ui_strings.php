    ...
    public static function get($identifier) {
        ...
        switch ($identifier) {
            ...
            case 'FIELD_HELP_TEXT_IMAGEV':
                return __("Displays image",'registration-gold');
            ...
            case 'FIELD_HELP_TEXT_PRICEV':
                return __("Price Widget",'registration-gold');
                
            case 'FIELD_HELP_TEXT_SUB_COUNDOWN':
                return __("Submission Limit Countdown Widget",'registration-gold');    
            ...
            case 'HELP_MAP_WIDTH':
                 return __('Width of the map widget in the form.','custom-registration-form-builder-with-submission-manager');    
