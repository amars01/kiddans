<ul class="rm-widget-selector-view">
    ...
    <li title="" class="rm_button_like_links" onclick="add_new_widget_to_page('ImageV')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_IMAGEV"); ?>">
    ...
    <li title="" class="rm_button_like_links" onclick="add_new_widget_to_page('PriceV')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_PRICEV"); ?>">
        <div class="rm-difl rm-widget-icon rm-widget-add-image"><i class="material-icons">&#xE263;</i></div> 
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"> Price</a>
        </div>
    </li>
    
    <li title="" class="rm_button_like_links" onclick="add_new_widget_to_page('SubCountV')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_SUB_COUNDOWN"); ?>">
        <div class="rm-difl rm-widget-icon rm-widget-add-image"><i class="material-icons">&#xE439;</i></div> 
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"> Submission Countdown</a>
        </div>
    </li>
    
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('MapV')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_MAPV"); ?>">
    ...
    <li class="rm_button_like_links" onclick="add_new_widget_to_page('Form_Chart')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_FORM_CHART"); ?>">
     ...
     <li class="rm_button_like_links" onclick="add_new_widget_to_page('FormData')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_FORM_DATA"); ?>">
     ...
     <li class="rm_button_like_links" onclick="add_new_widget_to_page('Feed')" title="<?php echo RM_UI_Strings::get("FIELD_HELP_TEXT_FEED"); ?>">
        <div class="rm-difl rm-widget-icon rm-widget-registration-feed"><i class="material-icons">&#xE0E5;</i></div> 
        <div class="rm-difl rm-widget-head"><a href="javascript:void(0)"><?php echo $data->form->form_type==0 ? 'Submission Feed' : 'Registration Feed'; ?></a>
        </div>
    </li>
